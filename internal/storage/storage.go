...
// Get retrieves a single entity by ID
func (s *InMemoryStore) Get(entityType string, id string) (map[string]interface{}, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
// Update replaces an entire entity
func (s *InMemoryStore) Update(entityType string, id string, data map[string]interface{}) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
// Patch partially updates an entity
func (s *InMemoryStore) Patch(entityType string, id string, data map[string]interface{}) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
// Delete removes an entity
func (s *InMemoryStore) Delete(entityType string, id string) error {
	s.mu.Lock()
	defer s.mu.Unlock()
