...
func TestHandleList(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/"+tt.entityType, nil)
			w := httptest.NewRecorder()
...
func TestHandleGetOne(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodGet, "/"+tt.entityType+"/"+tt.id, nil)
			w := httptest.NewRecorder()
...
func TestHandleDelete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			req := httptest.NewRequest(http.MethodDelete, "/"+tt.entityType+"/"+tt.id, nil)
			w := httptest.NewRecorder()
...
func TestFullCRUDWorkflow(t *testing.T) {
	...
	// 7. Verify deletion
	getAfterDelete := httptest.NewRequest(http.MethodGet, "/users/"+id, nil)
	w = httptest.NewRecorder()
