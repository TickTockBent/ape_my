...
func (s *Server) handleGetOne(entityName string, id string, w http.ResponseWriter, r *http.Request) {
	entity, err := s.store.Get(entityName, id)
	if err != nil {
...
func (s *Server) handleDelete(entityName string, id string, w http.ResponseWriter, r *http.Request) {
